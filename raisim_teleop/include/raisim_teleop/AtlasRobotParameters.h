...
public:
    RobotParameters()
    {
        ...
        WalkParameters[H0] = 0.11;
        WalkParameters[HY] = 0.0;
        WalkParameters[HX] = 0.03;
        WalkParameters[ComZ] = 0.26;
        WalkParameters[Tstep] = 0.45; //0.28
        WalkParameters[Tinit]= 0.4;
        WalkParameters[Tss] = 1.5; //0.3
        WalkParameters[Tds] = 0.5; //0.05
        WalkParameters[MaxStepX] = 0.5;
        WalkParameters[MaxStepY] = 0.5;//2.0*WalkParameters[H0] + 0.01;
        WalkParameters[MaxStepTheta] = 0.349065850401537;
        WalkParameters[MinStepX] = -0.5;
        WalkParameters[MinStepY] =  0.22;//2.0*WalkParameters[H0];
